                ...
                <div class="bg-white rounded-xl shadow-lg border border-slate-200 p-6 flex flex-col justify-between transition-transform hover:-translate-y-1" data-course-id="${course.id}">
                    <div>
                        ...
                        ${course.status === 'Finalizado' 
                            ? `<span class="text-xs font-semibold bg-green-100 text-green-800 px-2 py-1 rounded-full mb-2 inline-block">Finalizado</span>`
                            : `<span class="text-xs font-semibold bg-blue-100 text-blue-800 px-2 py-1 rounded-full mb-2 inline-block">Em Andamento</span>`
                        }
