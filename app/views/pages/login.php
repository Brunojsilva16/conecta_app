...
<script>
// A lógica do JavaScript permanece a mesma, mas agora usa a mensagem genérica
document.getElementById('formLogin').addEventListener('submit', async function(e) {
    ...
    try {
        ...
        // Tenta obter o JSON (mesmo em caso de erro HTTP, o AuthController envia JSON)
        const result = await response.json();

        if (result.success) {
            // Sucesso e transição suave
            ...
            // Falha (Mantém a mensagem genérica por segurança, como solicitado)
