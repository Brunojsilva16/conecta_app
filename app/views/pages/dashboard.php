...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function renderCourses() {
        ...
        // Função para criar o card de um curso
        ...
        // Renderiza os cursos finalizados
    ...
    // Event listener unificado para os dois containers
    document.getElementById('dashboard-view').addEventListener('click', function(e) {
        ...
        if (action === 'finish') {
            course.user_status = 'Finalizado';
        } else if (action === 'reopen') {
            course.user_status = 'Em Andamento';
        }
