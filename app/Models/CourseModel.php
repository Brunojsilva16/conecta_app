...
class CourseModel
{
    ...
    /**
     * Busca os cursos de um utilizador específico (não premium).
     */
    ...
    /**
     * Busca todos os cursos publicados e o progresso do utilizador neles (para premium).
     * Esta é a função corrigida.
     */
    public function findAllPublishedWithUserStatus(int $userId): array
    {
        // Esta query busca todos os cursos e utiliza um LEFT JOIN para encontrar o estado
        // correspondente para o utilizador atual. Se não encontrar, assume 'Em Andamento'.
        $sql = "
            SELECT
                c.*,
